...
# NOTE: This only for developlment, remove on production.
try:
    db["organization"].insert_many(
        [{'name': 'Abdullah Gül Üniversitesi', 'domain': 'agu.edu.tr'},
         ...
         {'name': 'Zonguldak Bülent Ecevit Üniversitesi',
          'domain': 'beun.edu.tr'},
         {'name': 'Üniversite Adı', 'domain': 'Websitesi'},
